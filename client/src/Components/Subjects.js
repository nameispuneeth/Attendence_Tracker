...
export default function Subjects(){
    ...
    return(
        <div className="flex flex-col justify-center items-center bg-gray-700 space-y-10 min-h-screen ">
            <p className="text-white font-bold text-2xl sm:text-3xl">Enter Number Of Subjects : </p>
            <div className='space-y-6 flex flex-col items-center bg-gray-300 p-6 rounded-2xl shadow-md'>
            ...
            {[...Array(cnt)].map((_,i)=>(
                <div className='text-white flex gap-5 items-center bg-gray-300 p-4 rounded shadow-xl' key={i}>
                    <p className='text-gray-800'>Enter Subject - {i+1}  :  </p>
                    <input type='text' className='text-gray-900 text-center border-b-2 border-gray-900 bg-gray-300 font-semibold focus:outline-none' value={subjects[i]} onChange={(e)=>{
