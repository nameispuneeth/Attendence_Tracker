...
export default function ReqAttendence(){
    ...
    return(
        <div className="h-screen bg-gray-600 flex flex-col justify-center items-center space-y-12">
            <div className="flex flex-col justify-center items-center space-y-10">
                <p className="text-white text-wrap text-2xl text-center font-bold">Enter Your Required Attendence Percentage : </p>
            ...
            <button className="text-gray-700 border border-gray-300 bg-gray-300 shadow-lg px-5 py-3 text-lg rounded font-semibold">Submit</button>
        </div>
    )
}